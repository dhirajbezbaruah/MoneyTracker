                    ...
                    return Container(
                      ...
                      child: ListTile(
                        contentPadding: const EdgeInsets.symmetric(
                          horizontal: 20,
                          vertical:
                              4, // Reduced from 12 to 4 for consistent height
                        ),
                        visualDensity: VisualDensity(
                            vertical: -4), // Added for consistent height
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(16),
                        ),
                        leading: CircleAvatar(
                          radius: 24,
                          backgroundColor: profile.isSelected
                          ...
                          children: [
                            ...
                            if (profile.id != selectedProfile?.id)
                              Container(
                                ...
                                child: InkWell(
                                  onTap: () => _showDeleteConfirmation(profile),
                                  customBorder: const CircleBorder(),
                                  child: Icon(
